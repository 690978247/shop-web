...
import SKULeftSection from './components/SKULeftSection.vue'
import SKUMainSection from './components/SKUMainSection.vue'
import SKUNavigationSection from './components/SKUNavigationSection.vue'
import SKUTopToolsSection from './components/SKUTopToolsSection.vue'
...
const render = (from: string) => {
  ...
  canvasEditor.renderStageJSON({
    json: stage
  })
}

const reload = () => {
  store.loaddata(props.dataInfo)
}
